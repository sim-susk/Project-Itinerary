export const cities = [
  
  {
    ...
    text: "Město středočeského kraje zapsané na Seznam světového dědictví UNESCO. Hrad čí zámek, zde budete hledat jen těžko, ale útulné historické centrum a spoustu sportovně-kulturního vyžití v okolí vám to bohatě vynahradí. Nevynechejte muzeum stříbra včetně stříbrného dolu, osvěžte se v místních kavárnách a restauracích a vydejte se po stopách tamějších horníků, kteří zasvětili kostel sv. Barboře, přímluvkyni a ochránkyni všech kdo mají nebezpečné povolání.",
  ...
  },
  {
    ...
    text: "Starobylé město s biblickým jménem Tábor láká svou slavnou minulostí, protože právě odsud vyráželi Husité na své vítězné výpravy.  Atmosféra města je cítit na každém kroku, především v historickém centru, kde můžete nahlédnout i do táborského středověkého podzemí. Vhodnou kulisou k poznávání města jsou zdobené štíty měšťanských domů, pomník Jana Žižky z Trocnova i gotická radnice. Pro ty nejmenší zde najdete muzeum lega a každoroční světelné show na téma Star Wars.",
  ...
  },
  {
    ...
    text: "Malebné město na pomezí Čech, Moravy a Rakouska proslavily překrásné renesanční měšťanské domy s bohatě zdobenými štíty a psaníčkovými sgrafity. Projděte se po stezkách, kudy chodíval loupežník Grasel a objevte mírumilovnou krajinu, stinné lesy, starobylé aleje, mýtická zákoutí a snad i dávná obětiště Keltů. Cestou si namalujte vlastní hrnek v keramické dílně v Maříži a navštivte prodejnu s originální keramikou.",
...

  {
    ...
    text: "Výstavní lázeňské domy, více než stovka minerálních pramenů, několik kolonád v čele s litinovou novobarokní kolonádou z konce 19. století, divadlo, Městské muzeum, památníky a pomníky, rozhledna Hamelika, zpívající fontána a solná jeskyně – to všechno jsou Mariánské Lázně. Město proslulé svými parky a zahradami si v minulosti kromě velkých umělců zamilovali i představitelé světové šlechty. Zamilujte se nyní i vy a vyměňte chorvatskou promenádu za tu mariánskou.",

    imgSrc: "marianske-lazne.jpg",
  ...
  },
  {
    ...
    text: "Růžová hora v Českém Švýcarsku si svou přezdívku Děčínská Fudžijama zaslouží. Obě hory spojuje sopečný původ, osamocená dominantní poloha i kouzelné fotografie, na nichž se z mlhy a mraků vynořují typické vrcholové kužely. Pohádková krajina Českého Švýcarska s množstvím pískovcových skal nabízí ale mnohem víc. Najdete tu rozhledny, atraktivní skalní vyhlídky, poutní místa a město Děčín s půvabným zámkem a zoologickou zahradou, kterou ocení nejen děti ale i dospělé.",

    imgSrc: "ceske-svycarsko.jpg",
...
{
  name: "Praha",
  title: "Petřínská Eiffelovka",
  tags: "travelWW",

  text: "Petřínská rozhledna poskytne krásný výhled na celé město, jen s těží uvěříte, že se nenacházíte v Paříži. Projděte se krásným parkem a skočte si v centru Prahy na křupavý croissant, který ucelí francouzskou atmosféru. Au revoir!",
